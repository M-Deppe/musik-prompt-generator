...
const IMPRINT = {
  ...
  body: [
    ...
    { h: "Anwendung", p: "Musik Prompt Generator V1 — Open-Source-Tool zur Erstellung von Style-Prompts für AI-Musik-Tools wie Suno und Udio. Lokaler Einsatz, keine Datensammlung." },
    { h: "Haftungsausschluss", p: "Generierte Prompts sind Vorschläge. Für kommerzielle Nutzung der KI-generierten Musik gelten die Nutzungsbedingungen der jeweiligen Plattform (Suno/Udio etc.)." },
  ],
};
